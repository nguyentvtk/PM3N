    ...
    <div className="w-full max-w-md animate-fade-in">
      ...
      <div className="glass-strong rounded-3xl p-10 text-center">
        ...
        <p className="text-sm mb-8" style={{ color: 'var(--text-muted)' }}>
          PM3N — Hệ thống quản lý hồ sơ nội bộ
        </p>

        {/* Error */}
        {error && (
          <div className="mb-6 p-3 rounded-xl text-sm text-red-400 border"
            style={{ background: 'rgba(239,68,68,0.08)', borderColor: 'rgba(239,68,68,0.2)' }}>
            {error === 'AccessDenied'
              ? '🚫 Email của bạn chưa được cấp quyền truy cập. Liên hệ quản trị viên.'
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-6 rounded-xl font-medium transition-all duration-200"
          style={{
      ...
      <p className="text-center mt-6 text-xs" style={{ color: 'var(--text-muted)' }}>
        © 2026 PM3N Workspace · Antigravity
      </p>
    </div>
  );
}
